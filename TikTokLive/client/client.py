...
from TikTokLive.events.proto_events import EVENT_MAPPINGS, BarrageEvent, ProtoEvent
...
class TikTokLiveClient(AsyncIOEventEmitter):
    ...
    def __init__(
        ...
        :param is_userid: Compatibility alias for is_user_id.
        ...
        # Properties
        self._is_user_id: bool = is_user_id if is_userid is None else is_userid
    ...
    async def start(
        ...
        try:
            ...
            sign_kwargs = {"platform": self._ws_platform, "preferred_agent_ids": preferred_agent_ids}
